...
public class BuyTicketUI extends JFrame {
    ...
    public BuyTicketUI() {
        ...
        // OOP: Lấy danh sách tên trạm từ MetroService thay vì mảng cứng
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                if (ticket.getPrice() > 0) {
                    ...
                    JOptionPane.showMessageDialog(container, 
                        "Vui lòng chọn Ga đi và Ga đến hợp lệ!", 
    ...
    // ... Copy tiếp các hàm hỗ trợ khác (header, footer, ticketCard...) ...
